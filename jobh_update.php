<?php
include('conn.php');
if (isset($_POST['update_jobh'])) {
	$jobh_id = $_POST['jobh_id'];
	$per_id = $_POST['per_id'];
	$com_id = $_POST['com_id'];
	...
	$qupdate = "UPDATE job_history SET com_id_baru = '$com_id', tgl_jabat = '$tgl_jabat', per_position_baru = '$per_position_baru', per_department_baru = '$per_department_baru' WHERE jobh_id = '$jobh_id';";
